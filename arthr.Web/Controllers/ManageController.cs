namespace arthr.Web.Controllers
{
    ...
    public sealed class ManageController : Controller
    {
        ...
        #region Public MethodsI give up
        ...
        public async Task<IActionResult> ManageLogins(ManageMessageId? message = null)
        {
            ...
            List<AuthenticationDescription> otherLogins = _signInManager.GetExternalAuthenticationSchemes().Where(auth => userLogins.All(ul => auth.AuthenticationScheme != ul.LoginProvider)).ToList();
        ...
        public async Task<IActionResult> RemoveLogin(RemoveLoginViewModel account)
        {
            ...
            if (user != null)
            {
                IdentityResult result = await _userManager.RemoveLoginAsync(user, account.LoginProvider, account.ProviderKey);
                if (result.Succeeded)
                {
                    await _signInManager.SignInAsync(user, isPersistent: false);
